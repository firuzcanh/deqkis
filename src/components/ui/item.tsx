...
const itemVariants = cva(
  'rounded-md border text-sm w-full group/item focus-visible:border-ring focus-visible:ring-ring/50 flex items-center flex-wrap outline-none transition-colors duration-100 focus-visible:ring-[3px] [a]:transition-colors',
  {
    variants: {
      variant: {
        default: 'border-transparent [a]:hover:bg-subtle',
        outline: 'border-border [a]:hover:bg-subtle',
        muted: 'bg-muted border-transparent [a]:hover:bg-subtle',
      },
      size: {
